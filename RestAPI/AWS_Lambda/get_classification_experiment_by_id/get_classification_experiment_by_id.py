...
# -*- coding: utf-8 -*-
"""
Created 2017-05-08 22:17
Function that get classification experiments by id(comma separated list)
@author: luis
"""
import pymysql.cursors


def get_classification_experiment_by_id(event,context):
    #TODO: 
    ...
    experiments = list()
    classification_experiment_list = event["params"]["path"]["classification_experiment_list"]
    try:
        with connection.cursor(pymysql.cursors.DictCursor) as cursor:
            sql = """SELECT ClassificationExperiment.PKClassificationExperiment,
						...
						FROM ML_log_book.ClassificationExperiment WHERE PKClassificationExperiment IN ("""+classification_experiment_list+");"""
            cursor.execute(sql)
