...
# -*- coding: utf-8 -*-
"""
Created 2017-05-08 21:34
Function that lists all classification experiments in the DB
@author: luis
"""
import pymysql.cursors


def list_classification_experiments(event,context):
    #TODO: 
    ...
    try:
        with connection.cursor(pymysql.cursors.DictCursor) as cursor:
            sql = """SELECT ClassificationExperiment.PKClassificationExperiment,
						...
						FROM ML_log_book.ClassificationExperiment;"""
            cursor.execute(sql)
