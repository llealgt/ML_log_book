...
Function that list experimeng groups given a project id
@author: luis
"""
import pymysql.cursors


def get_experiment_group_by_project(event,context):
    #TODO: 
    ...
    try:
        with connection.cursor(pymysql.cursors.DictCursor) as cursor:
            sql = """SELECT ExperimentGroup.PKExperimentGroup,
					...
					LEFT OUTER JOIN Tool ON FKTool = PKTool WHERE FKProject IN ("""+project_id+")"
            cursor.execute(sql)
